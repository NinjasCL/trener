...
#import "DoubleInputTableViewCell.h"

@implementation DoubleInputTableViewCell
...
- (void)initalizeInputView {
	...
	self.detailTextLabel.text = [self.numberFormatter stringFromNumber:[NSNumber numberWithDouble:self.numberValue]];
}
...
- (BOOL)resignFirstResponder {
	if (valueChanged && delegate && [delegate respondsToSelector:@selector(tableViewCell:didEndEditingWithDouble:)]) {
		[delegate tableViewCell:self didEndEditingWithDouble:self.numberValue];
	}
